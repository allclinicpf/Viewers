 ...
 */
var _sharedIsRefreshing = false;
var _sharedPendingRequests = [];
var DICOMwebClient = /*#__PURE__*/function () {
  _createClass(DICOMwebClient, [{
    key: "processPendingRequests",
    value: function processPendingRequests(success) {
      var pending = _sharedPendingRequests;
      _sharedPendingRequests = [];
      pending.forEach(function (_ref) {
  ...
  _createClass(DICOMwebClient, [{
    ...
    value: function _httpRequest(url, method) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        request.onreadystatechange = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          var contentType, responseStatusCode, sentUrl, domain, refreshUrl, retryResponse, error;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 2:
                  ...
                  contentType = request.getResponseHeader('Content-Type'); // Automatically distinguishes between multipart and singlepart in an array buffer, and
                ...
                case 17:
                  ...
                  sentUrl = request.responseURL || url; // If the request failed due to an unauthorized error,
                  ...
                  if (!(responseStatusCode === 401 && !sentUrl.includes('refresh') && !_sharedIsRefreshing)) {
                    _context.next = 42;
                    break;
                  }
                  _sharedIsRefreshing = true;
                  _context.prev = 21;
                  domain = new URL(sentUrl).origin;
                  refreshUrl = _this.refreshEndpoint.startsWith('http') ? _this.refreshEndpoint : "".concat(domain).concat(_this.refreshEndpoint);
                  _context.next = 26;
                  return _this.refreshToken(refreshUrl);
                case 26:
                  _context.next = 28;
                  return _this._httpRequest(url, method, headers, options);
                case 28:
                  retryResponse = _context.sent;
                  _sharedIsRefreshing = false;
                  _this.processPendingRequests(true);
                ...
                case 35:
                  ...
                  _sharedIsRefreshing = false;
                  _this.processPendingRequests(false, _context.t0);
                  console.error('token refresh failed: ', _context.t0);
                  reject(error);
                  return _context.abrupt("return");
                case 42:
                  if (!_sharedIsRefreshing) {
                    _context.next = 45;
                    break;
                  }
                  _sharedPendingRequests.push({
                    resolve: resolve,
                    reject: reject,
    ...
    key: "refreshToken",
    value: function () {
      var _refreshToken = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(refreshUrl) {
        var refreshRequest;
                  ...
                  refreshRequest.onreadystatechange = function () {
                    if (refreshRequest.readyState === 4) {
                      if (refreshRequest.status === 200) {
                        ...
                        var error = new Error('token refresh failed');
